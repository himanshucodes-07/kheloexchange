...
@keyframes ticker {
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<section class="recent-game-section spad " data-setbg="img/recent-game-bg.png">
				<div>
			...
			<c:if test = "${not empty gameImages}">
			<section class="recent-game-section spad set-bg" data-setbg="img/recent-game-bg.png">
				<div class="container">
					...
					<div class="newGame">
					<c:forEach items="${gameImages}" var="gameImg" varStatus="loop">
						<a href="fetchIdDetails">
							<div>
								<div class="recent-game-item">
									<div class="rgi-thumb set-bg" data-setbg="${gameImg.imageLink}">
										<div class="cata new">new</div>
									</div>
									<div class="rgi-content">
										<h5>${gameImg.subject}</h5>
										<p>${gameImg.message}</p>
									</div>
								</div>
							</div>
			...
			<section class="recent-game-section spad set-bg" style="background-image: url('img/recent-game-bg.png');">
				<div class="container">
				  <div class="section-title">
					<div class="cata new">new</div>
					<h2>Upcoming Games</h2>
				  </div>
				  <div id="recentGameCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					<!-- Indicators -->
					<ol class="carousel-indicators">
					  <li data-bs-target="#recentGameCarousel" data-bs-slide-to="0" class="active" aria-label="Slide 1"></li>
					  <li data-bs-target="#recentGameCarousel" data-bs-slide-to="1" aria-label="Slide 2"></li>
					  <li data-bs-target="#recentGameCarousel" data-bs-slide-to="2" aria-label="Slide 3"></li>
					</ol>
					
					<div class="carousel-inner">
					  <div class="carousel-item active">
						<div class="recent-game-item">
						  <div class="rgi-thumb" style="background-image: url('img/recent-game/1.jpg');">
							<div class="cata new">new</div>
						  </div>
						  <div class="rgi-content">
							<h5>Feeling lucky? Take a spin on the roulette wheel</h5>
					  ...
					  <div class="carousel-item">
						<div class="recent-game-item">
						  <div class="rgi-thumb" style="background-image: url('img/recent-game/2.jpg');">
							<div class="cata racing">racing</div>
						  </div>
						  <div class="rgi-content">
							<h5>And for those looking for the ultimate thrill, step into our live casino</h5>
					  ...
					  <div class="carousel-item">
						<div class="recent-game-item">
						  <div class="rgi-thumb" style="background-image: url('img/recent-game/3.jpg');">
							<div class="cata adventure">Adventure</div>
						  </div>
						  <div class="rgi-content">
							<h5>Interact with real dealers in real-time.</h5>
			...
			<section class="spad">
				<div class="container">
					...
					<center>
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                          <img class="d-block w-30" src="img/Gaming Api/1.png" alt="...">
                           </div>
                         <div class="carousel-item">
                         <img class="d-block w-30" src="img/Gaming Api/2.png" alt="...">
                         </div>
                          <div class="carousel-item"> 
                          <img class="d-block w-30" src="img/Gaming Api/3.jpg" alt="...">
                          </div>
                          <div class="carousel-item">
                          <img class="d-block w-30" src="img/Gaming Api/4.png" alt="...">
                          </div>
                          <div class="carousel-item">
                          <img class="d-block w-30" src="img/Gaming Api/5.png" alt="...">
                          </div>
                          <div class="carousel-item">
                          <img class="d-block w-30" src="img/Gaming Api/6.png" alt="...">
                          </div>
                          <div class="carousel-item">
                          <img class="d-block w-30" src="img/Gaming Api/7.png" alt="...">
                          </div>
                          <div class="carousel-item">
                          <img class="d-block w-30" src="img/Gaming Api/8.png" alt="...">
                          </div>
                          </div>
                          </center>
                         </div>
		...
		<script src="js/gameLink.js"></script>
		<script src="js/jquery-3.2.1.min.js"></script>
		<script src="js/bootstrap.min.js"></script>
		<script src="js/owl.carousel.min.js"></script>
		<script src="js/jquery.marquee.min.js"></script>
		<script src="js/main.js"></script>
		<script src="js/top5MaximumDepositUsers.js"></script>
