...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
		...
		<head>
			...
			<script>
				...
				function showContent1() {
					...
					document.querySelector("#button4>button").style.backgroundColor = 'black';
					document.querySelector("#button4>button").style.color= 'white';
				...
				let showContent4 = () =>{
					...
					document.getElementById('content4').style.flexDirection = 'column';
					document.getElementById('content4').style.alignItems = 'center';
					document.querySelector("#button1 > button").style.backgroundColor = 'black';
					document.querySelector("#button2 > button").style.backgroundColor = 'black';
					document.querySelector("#button3 > button").style.backgroundColor = 'black';
					document.querySelector("#button4 > button").style.backgroundColor = 'white';
					document.querySelector("#button4>button").style.color= 'black';
					document.querySelector("#button1>button").style.color = 'white';
					document.querySelector("#button2>button").style.color = 'white';
					document.querySelector("#button3>button").style.color = 'white';
				}
		...
		<body>
			...
			<div class="button-container">
				...
				<div id="button4">
					<button class="btn btn-primary" onclick="showContent4()">Pending Transfer Balance to Another Game Wallet Request</button>
				</div>
			</div>
			...
			<section class=ids_data style="flex: 1; padding: 4%; justify-content: center;">
				...
				<div id="content2" class="content">
					...
					<c:if test="${not empty pendingDepositRequests }">
						<div class="container">
						<table id="example" class="table table-striped table-responsive border-dark table-hover text-center">
							<thead class="table-dark table-active text-uppercase text-whites">
								<tr>
				...
				<div id="content3" class="content">
					...
					<h1 class="text-center text-white p2 bg-dark bg-gradient text-uppercase">Pending Transfer Balance to Another Game Wallet Request</h1>
					<div class="container">
					<table id="example" class="table table-striped table-responsive border-dark table-hover text-center">
						<thead class="table-dark table-active text-uppercase text-whites">
							<tr>
						...
						<tbody>
						<c:forEach items="${pendingWalletBalanceTransferRequests}" var="balanceTransferRequest">
							<c:if test="${not balanceTransferRequest.status}">
								<tr>
									<td>${balanceTransferRequest.id}</td>
									<td>${balanceTransferRequest.websiteName}</td>
									<td>${balanceTransferRequest.website}</td>
									<td>${balanceTransferRequest.amount}</td>
									<td>${balanceTransferRequest.timestamp}</td>
									<td>Pending</td>
								</tr>
							</c:if>
						</c:forEach>
