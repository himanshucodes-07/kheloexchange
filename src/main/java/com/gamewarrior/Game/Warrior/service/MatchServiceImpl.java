...
import com.gamewarrior.Game.Warrior.dao.MatchRepo;
    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                Elements bowlingTeamInfo = match.select("div.cb-hmscg-bwl-txt");
                String bowlingTeam = bowlingTeamInfo.select("div.cb-hmscg-tm-nm").text();
                String bowlingTeamScore = bowlingTeamInfo.select("div.cb-hmscg-tm-nm+div").text();
                ...
                match1.setBowlingTeam(bowlingTeam);
